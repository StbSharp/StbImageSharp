...
namespace StbImageSharp
{
	public unsafe class ImageReader
	{
		...
		public Image Read(Stream stream, ColorComponents req_comp = StbImage.STBI_default)
		{
			_stream = stream;
		...
		public AnimatedGifFrame[] ReadAnimatedGif(Stream stream, out int x, out int y, out int comp, ColorComponents req_comp)
		{
			try
			{
				x = y = comp = 0;
